...
const HSB_SCHEIDINGSWAND_MATS: MaterialSection[] = HSB_VOORZETWAND_BINNEN_MATS.flatMap((section) => {
  if (section.key === 'constructieplaat') {
    return [
      { ...section, label: 'Constructieplaat (Zijde 1)', key: 'constructieplaat_1' },
      { ...section, label: 'Constructieplaat (Zijde 2)', key: 'constructieplaat_2' },
    ];
  }
  if (section.key === 'afwerkplaat') {
    return [
      { ...section, label: 'Afwerkplaat (Zijde 1)', key: 'afwerkplaat_1' },
      { ...section, label: 'Afwerkplaat (Zijde 2)', key: 'afwerkplaat_2' },
    ];
  }
  return [{ ...section }];
});
...
const HSB_BUITENWAND_MATS: MaterialSection[] = [
  // 1. HOUT & CONSTRUCTIE
  { label: 'Staanders & Liggers', categoryFilter: 'Vuren hout', category: 'hout', key: 'regelwerk_hoofd', category_ultra_filter: 'Balken' },
  { label: 'Tengelwerk / Rachels', categoryFilter: 'Vuren hout', category: 'hout', key: 'regelwerk_inst', category_ultra_filter: 'Rachels' },

  // 2. ISOLATIE & FOLIES
  { label: 'Folie Buiten', categoryFilter: 'Folieën, Dpc', category: 'isolatie', key: 'folie_buiten', category_ultra_filter: 'Dampopen' },
  { label: 'Folie Binnen', categoryFilter: 'Folieën', category: 'isolatie', key: 'folie_binnen', category_ultra_filter: 'Dampremmend' },
...
const PLAFOND_HOUT_MATS: MaterialSection[] = [
  // 1. HOUT & CONSTRUCTIE (FRAMEWERK)
  { label: 'Balklaag', categoryFilter: 'Vuren hout', category: 'hout', key: 'randhout', category_ultra_filter: 'Ribben' },
  { label: 'Rachelwerk', categoryFilter: 'Vuren hout', category: 'hout', key: 'rachels', category_ultra_filter: 'Rachels' },
...
const DAGKANT_MATS: MaterialSection[] = [
  ...
  { label: 'Afwerkplaat', categoryFilter: 'Gipsplaten, Interieur Platen', category: 'afwerking', key: 'dagkant', category_ultra_filter: '', multiEntry: true },
  { label: 'Hoekprofielen', categoryFilter: 'Stucwerk', category: 'afwerking', key: 'hoekprofiel', category_ultra_filter: 'Hoekprofielen', multiEntry: true },
];
...
const KOOF_MATS: MaterialSection[] = [
  ...
  { label: 'Hoekprofielen', categoryFilter: 'Stucwerk', category: 'afwerking', key: 'hoekprofielen', category_ultra_filter: 'Hoekprofielen', multiEntry: true },
];
...
const DEUR_BINNEN_MATS: MaterialSection[] = [
  ...
  { label: 'Stofdorpel', categoryFilter: 'Kozijnhout', category: 'tochtstrips', key: 'stofdorpel', category_ultra_filter: 'Stofdorpel' },

  { label: 'Deurroosters', categoryFilter: 'Deurbeslag', category: 'ventilatie', key: 'ventilatierooster', category_ultra_filter: '' },
];
...
const DEUR_BUITEN_MATS: MaterialSection[] = [
  ...
  { label: 'Glaslatten', categoryFilter: 'Afwerking', category: 'glas', key: 'glaslatten', category_ultra_filter: 'Glaslatten' },
...
const BOEIBOORD_ROCKPANEL_MATS: MaterialSection[] = [
  ...
  { label: 'Balklaag', categoryFilter: 'Vuren hout', category: 'hout', key: 'balklaag', category_ultra_filter: 'Balken' },
...
const BOEIBOORD_TRESPA_MATS: MaterialSection[] = [
  ...
  { label: 'Voegband', categoryFilter: 'Overig', category: 'afwerking', key: 'voegband', category_ultra_filter: '' },
  { label: 'Eindprofiel', categoryFilter: 'Overig', category: 'afwerking', key: 'eindprofiel', category_ultra_filter: '' },
  { label: 'Afwerkprofielen', categoryFilter: 'Overig', category: 'afwerking', key: 'afwerk_profiel', category_ultra_filter: '' },
  { label: 'Trespa schroeven', categoryFilter: 'Overig', category: 'afwerking', key: 'bevestiging', category_ultra_filter: '' },
...
const GEVEL_BEKLEDING_BASE_MATS: MaterialSection[] = [
  // 1. BASIS (SKELETON)
  { label: 'Ventilatielat', categoryFilter: 'Vuren hout', category: 'hout', key: 'tengelwerk_basis', category_ultra_filter: '' },
  { label: 'Regelwerk', categoryFilter: 'Vuren hout', category: 'hout', key: 'rachelwerk_basis', category_ultra_filter: '' },
...
const GEVEL_BEKLEDING_TRESPA_MATS: MaterialSection[] = [
  ...GEVEL_BEKLEDING_BASE_MATS,
  { label: 'Volkern/HPL Plaat', categoryFilter: 'Trespa', category: 'gevel_plaat', key: 'gevelplaat', category_ultra_filter: '' },
...
const KOZIJN_BINNEN_HOUT_MATS: MaterialSection[] = [
  { label: 'Kozijn (Complete Set)', categoryFilter: 'Montage kozijnen', category: 'hout', key: 'kozijn_compleet', category_ultra_filter: '', multiEntry: true, syncToJobAantal: true },
  { label: 'Kozijnhout (Zelfbouw)', categoryFilter: 'Hardhout geschaafd', category: 'hout', key: 'kozijnhout', category_ultra_filter: '', multiEntry: true, syncToJobAantal: true },
  { label: 'Binnendorpel', categoryFilter: 'Hardhout geschaafd, Merantie', category: 'hout', key: 'binnendorpel', category_ultra_filter: '', multiEntry: true },

  { label: 'Scharnieren', categoryFilter: 'Deurbeslag', category: 'beslag', key: 'scharnieren', category_ultra_filter: '', multiEntry: true },
  ...
  { label: 'Glaslatten', categoryFilter: 'Afwerking', category: 'glas', key: 'glaslatten', category_ultra_filter: 'Glaslatten', multiEntry: true },
...
const KOZIJN_BINNEN_STAAL_MATS: MaterialSection[] = [
  ...
  { label: 'Glas', categoryFilter: 'Overig', category: 'glas', key: 'glas_bovenlicht', category_ultra_filter: '', multiEntry: true },
  { label: 'Glaslatten', categoryFilter: 'Afwerking', category: 'glas', key: 'glaslatten_klik', category_ultra_filter: 'Glaslatten', multiEntry: true },
];

// 3. BUITEN KOZIJNEN - HOUT (PREFAB / FABRIEK)
const KOZIJN_BUITEN_HOUT_MATS: MaterialSection[] = [
  { label: 'Kozijnelement', categoryFilter: 'Kozijnhout', category: 'element', key: 'prefab_kozijnelement', category_ultra_filter: '', multiEntry: true, syncToJobAantal: true },
  { label: 'Stelkozijnen', categoryFilter: 'Vuren hout', category: 'element', key: 'stelkozijnen', category_ultra_filter: '', multiEntry: true },

  { label: 'Raamdorpelstenen', categoryFilter: 'Overig', category: 'afwerking_buiten', key: 'raamdorpel_steen', category_ultra_filter: '', multiEntry: true },
  { label: 'Lood / DPC', categoryFilter: 'Lood, Loodvervanger, Dpc', category: 'afwerking_buiten', key: 'lood_dpc', category_ultra_filter: '', multiEntry: true },

  { label: 'Dagkantbetimmering', categoryFilter: 'Interieur Platen, Constructieplaten', category: 'afwerking_binnen', key: 'dagkantafwerking', category_ultra_filter: '', multiEntry: true },
  { label: 'Vensterbank', categoryFilter: 'vensterbanken', category: 'afwerking_binnen', key: 'vensterbank', category_ultra_filter: '', multiEntry: true },
  { label: 'Koplatten', categoryFilter: 'Afwerking', category: 'afwerking_binnen', key: 'koplatten', category_ultra_filter: '', multiEntry: true },
];

// 4. BUITEN KOZIJNEN - KUNSTSTOF (PREFAB)
const KOZIJN_BUITEN_KUNSTSTOF_MATS: MaterialSection[] = [
  { label: 'Kozijnelement', categoryFilter: 'Overig', category: 'element', key: 'profiel', category_ultra_filter: '', multiEntry: true, syncToJobAantal: true },
  { label: 'Onderdorpel', categoryFilter: 'Overig', category: 'element', key: 'onderdorpel', category_ultra_filter: '', multiEntry: true },

  { label: 'Stelkozijn', categoryFilter: 'Overig', category: 'montage', key: 'stelkozijn', category_ultra_filter: '', multiEntry: true },

  { label: 'Dagkantafwerking', categoryFilter: 'Overig', category: 'afwerking', key: 'dagkanten', category_ultra_filter: '', multiEntry: true },
  { label: 'Waterslag', categoryFilter: 'Overig', category: 'afwerking', key: 'waterslag', category_ultra_filter: '', multiEntry: true },
  { label: 'Inzethorren', categoryFilter: 'Overig', category: 'afwerking', key: 'inzethorren', category_ultra_filter: '', multiEntry: true },
];
...
const VLIZOTRAP_MATS: MaterialSection[] = [
  ...
  { label: 'Koplatten', categoryFilter: 'Afwerking', category: 'afwerking', key: 'architraaf', category_ultra_filter: 'koplatten', multiEntry: true, maxEntries: 1 },
];
  ...
  wanden: {
    ...
    items: [
      ...
      },
      {
        ...
        description: 'Volledige gevelopbouw',
        ...
        categoryConfig: {
          ...
          isolatie: { title: 'Isolatie & Folies', order: 2 },
          beplating: { title: 'Beplating', order: 3 },
          afwerking_binnen: { title: 'Binnenafwerking', order: 4 },
          gips_afwerking: { title: 'Stucwerk', order: 5 },
          Kozijnen: { title: 'Kozijnen & Ramen', order: 6 },
          Deuren: { title: 'Buitendeuren & Hang- en Sluitwerk', order: 7 },
          Dagkant: { title: 'Dagkanten', order: 8 },
          Vensterbank: { title: 'Vensterbanken', order: 9 },
        }
      },
