...
export function OfferteHulpIcon(props: SVGProps<SVGSVGElement>) {
  return (
    ...
    >
      ...
      <path d="M14 2v6h6" />
      <path d="M10.15 14.94a2.5 2.5 0 0 0-2.3 2.55 2.5 2.5 0 0 0 2.3 2.55" />
      <path d="M14.33 19.99a2.5 2.5 0 0 0 2.3-2.55 2.5 2.5 0 0 0-2.3-2.55" />
      <path d="m7.85 17.5-1.5 2.5" />
      <path d="m16.63 17.5 1.5 2.5" />
      <path d="M12 12v6" />
    </svg>
  );
}
