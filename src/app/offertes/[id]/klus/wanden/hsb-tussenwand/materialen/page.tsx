...
const sectieSleutels = ['balktype', 'isolatie', 'folie', 'binnenbekleding', 'buitenbekleding', 'gips_fermacell_1', 'gips_fermacell_2', 'kozijnen', 'deuren', 'naden_vullen', 'plinten', 'extra'] as const;
...
export default function HsbTussenwandMaterialenPage() {
  ...
  const handleMateriaalVerwijderen = (sectieSleutel: SectieKey) => {
    setGekozenMaterialen(prev => {
        ...
        if (sectieSleutel === 'gips_fermacell_1' || sectieSleutel === 'gips_fermacell_2') {
            setGipsLagen(1);
        }
        return newState;
    });
        ...
        <div className="flex-1 p-4 md:p-8">
          <div className="max-w-2xl mx-auto w-full">
              ...
              <div className="space-y-8">
                ...
                {renderSelectieRij('buitenbekleding', 'OSB / Constructieplaat')}

                {renderGipsSelectieRij('gips_fermacell_1', 'Gips / Fermacell')}
                {renderGipsSelectieRij('gips_fermacell_2', 'Gips / Fermacell')}
