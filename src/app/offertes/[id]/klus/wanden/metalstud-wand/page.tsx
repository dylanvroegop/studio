...
export default function MetalstudWandPage() {
  ...
  const handleSubmit = (event: React.MouseEvent<HTMLButtonElement>) => {
    ...
    localStorage.setItem(`quote-${quoteId}-metalstud-wanden`, JSON.stringify(walls));
    
    router.push(`/offertes/${quoteId}/klus/wanden/metalstud-wand/materialen`);
  };
