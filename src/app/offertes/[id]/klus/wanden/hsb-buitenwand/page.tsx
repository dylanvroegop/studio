...
export default function HsbBuitenwandPage() {
  ...
  const handleSubmit = (event: React.MouseEvent<HTMLButtonElement>) => {
    ...
    localStorage.setItem(`quote-${quoteId}-hsb-buitenwanden`, JSON.stringify(walls));
    
    router.push(`/offertes/${quoteId}/klus/wanden/hsb-buitenwand/materialen`);
  };
      ...
      <div className="flex-1 p-4 md:p-8">
        <div className="max-w-2xl mx-auto w-full">
            <div className="text-center mb-8">
                 <h2 className="font-semibold text-2xl">HSB Buitenwand (gevel)</h2>
