...
export default function GolfplaatDakPage() {
  ...
  const handleSubmit = (event: React.MouseEvent<HTMLButtonElement>) => {
    ...
    localStorage.setItem(`quote-${quoteId}-golfplaat-dak`, JSON.stringify(dakvlakken));
    
    router.push(`/offertes/${quoteId}/klus/dakrenovatie/golfplaat-dak/materialen`);
  };
      ...
      <div className="flex-1 p-4 md:p-8">
        <div className="max-w-2xl mx-auto w-full">
            <div className="text-center mb-8">
                 <h2 className="font-semibold text-2xl">Golfplaat Dak – Op Houten Constructie</h2>
