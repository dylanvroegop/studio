...
export default function DakrenovatiePage() {
  ...
  const subcategories: Subcategory[] = [
    ...
    { name: 'Dakrenovatie', description: 'Overig Dakrenovatie', icon: 'plus', href: `/offertes/${quoteId}/klus/dakrenovatie/overig-dakrenovatie` },
  ];
  ...
  return (
    <main className="flex flex-1 flex-col">
      <header className="sticky top-0 z-10 grid h-14 w-full grid-cols-3 items-center border-b bg-background/95 px-4 backdrop-blur-sm sm:px-6">
        ...
        <h1 className="text-center font-semibold text-lg">Dakrenovatie: stap 3 van 6</h1>
