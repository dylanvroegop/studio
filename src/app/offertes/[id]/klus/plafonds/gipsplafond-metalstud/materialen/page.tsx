...
const sectieSleutels = ['profielen', 'isolatie', 'folie', 'gips_fermacell', 'naden_vullen', 'extra', 'klein_materiaal'] as const;
...
export default function GipsplafondMetalstudMaterialenPage() {
  ...
  const JOB_TYPE = "gipsplafond-metalstud";
