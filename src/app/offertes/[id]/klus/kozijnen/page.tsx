  ...
  return (
    <main className="flex flex-1 flex-col">
      <header className="sticky top-0 z-10 flex h-14 items-center justify-between border-b bg-background/95 px-4 backdrop-blur-sm shadow-sm">
        ...
        <h1 className="font-semibold text-lg">Kozijnen: stap 3 van 4</h1>
        ...
        <div className="max-w-4xl mx-auto w-full">
          ...
          <div className="text-center mb-8">
            <p className="text-muted-foreground">
              Selecteer één of meerdere categorieën kozijnen. Voor elke gekozen categorie vult u in de volgende stap de specifieke details en materialen in.
            </p>
          </div>
