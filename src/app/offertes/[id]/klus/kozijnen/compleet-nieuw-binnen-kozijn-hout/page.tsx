...
export default function CompleetNieuwBinnenKozijnHoutPage() {
  ...
  const handleSubmit = (event: React.MouseEvent<HTMLButtonElement>) => {
    ...
    localStorage.setItem(`quote-${quoteId}-compleet-nieuw-binnen-kozijn-hout`, JSON.stringify(kozijnen));
    
    router.push(`/offertes/${quoteId}/klus/kozijnen/compleet-nieuw-binnen-kozijn-hout/materialen`);
  };
      ...
      <div className="flex-1 p-4 md:p-8">
        <div className="max-w-2xl mx-auto w-full">
            <div className="text-center mb-8">
                 <h2 className="font-semibold text-2xl">Compleet nieuw binnen kozijn – Hout</h2>
