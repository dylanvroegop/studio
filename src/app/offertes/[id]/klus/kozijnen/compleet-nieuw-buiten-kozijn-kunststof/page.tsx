...
export default function CompleetNieuwBuitenKozijnKunststofPage() {
  ...
  const handleSubmit = (event: React.MouseEvent<HTMLButtonElement>) => {
    ...
    localStorage.setItem(`quote-${quoteId}-buitenkozijn-kunststof`, JSON.stringify(kozijnen));
    
    router.push(`/offertes/${quoteId}/klus/kozijnen/compleet-nieuw-buiten-kozijn-kunststof/materialen`);
  };
