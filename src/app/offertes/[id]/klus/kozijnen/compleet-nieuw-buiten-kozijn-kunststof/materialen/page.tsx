...
const sectieSleutels = ['kozijn', 'glas', 'bevestiging', 'afwerking', 'extra', 'klein_materiaal'] as const;
    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent>
        <DialogHeader>
          ...
          <DialogDescription>
            Sla de huidige materiaalconfiguratie op voor later gebruik bij Kunststof Buitenkozijnen.
          </DialogDescription>
        </DialogHeader>
        <div className="space-y-4 py-4">
            <div className="space-y-2">
                <Label htmlFor="preset-name">Naam voorinstelling *</Label>
                <Input id="preset-name" value={name} onChange={(e) => setName(e.target.value)} placeholder="bv. Standaard kunststof buitenkozijn" />
            </div>
            <div className="flex items-center space-x-2">
                <Checkbox id="default-preset" checked={isDefault} onCheckedChange={(checked) => setIsDefault(checked as boolean)} />
                <Label htmlFor="default-preset">Maak dit mijn standaard voor Kunststof Buitenkozijnen</Label>
            </div>
        </div>
        <DialogFooter>
...
export default function CompleetNieuwBuitenKozijnKunststofMaterialenPage() {
  ...
  const JOB_TYPE = "compleet-nieuw-buiten-kozijn-kunststof";
        ...
        <div className="flex-1 p-4 md:p-8">
          <div className="max-w-2xl mx-auto w-full">
              <div className="text-center mb-8">
                   <h1 className="font-semibold text-2xl md:text-3xl">Materialen – Compleet nieuw buiten kozijn – Kunststof</h1>
              ...
              <div className="space-y-4">
                {renderSelectieRij('kozijn', 'Kunststof Kozijn')}
