...
const sectieSleutels = ['poort', 'palen', 'beslag', 'extra', 'klein_materiaal'] as const;
    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent>
        <DialogHeader>
          ...
          <DialogDescription>
            Sla de huidige materiaalconfiguratie op voor later gebruik bij Poorten/Tuindeuren.
          </DialogDescription>
        </DialogHeader>
        <div className="space-y-4 py-4">
            <div className="space-y-2">
                <Label htmlFor="preset-name">Naam voorinstelling *</Label>
                <Input id="preset-name" value={name} onChange={(e) => setName(e.target.value)} placeholder="bv. Standaard tuinpoort" />
            </div>
            <div className="flex items-center space-x-2">
                <Checkbox id="default-preset" checked={isDefault} onCheckedChange={(checked) => setIsDefault(checked as boolean)} />
                <Label htmlFor="default-preset">Maak dit mijn standaard voor Poorten/Tuindeuren</Label>
            </div>
        </div>
        <DialogFooter>
...
export default function PoortTuindeurMaterialenPage() {
        ...
        <div className="flex-1 p-4 md:p-8">
          <div className="max-w-2xl mx-auto w-full">
              ...
              <div className="space-y-4">
                {renderSelectieRij('poort', 'Poort/Deur')}
                {renderSelectieRij('palen', 'Palen')}
                {renderSelectieRij('beslag', 'Beslag (scharnieren, slot)')}
                {renderSelectieRij('extra', 'Extra materiaal', 'Optionele extra materialen.')}
              ...
              <div className="mt-8 flex justify-between items-center">
                  <Button variant="outline" asChild>
                      <Link href={`/offertes/${quoteId}/klus/schutting/poort-tuindeur`}>Terug</Link>
                  </Button>
                  <div>
