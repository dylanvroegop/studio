...
export default function DakIsolerenBinnenzijdePage() {
      ...
      <div className="flex-1 p-4 md:p-8">
        <div className="max-w-2xl mx-auto w-full">
            <div className="text-center mb-8">
                 <h2 className="font-semibold text-2xl">Dak isoleren (binnenzijde)</h2>
                   ...
                   <Card key={index}>
                       <CardHeader className="flex flex-row items-center justify-between">
                           <div>
                               ...
                               <CardDescription>
                                   Specificeer de afmetingen voor dit dakvlak.
                               </CardDescription>
                           </div>
                            {index > 0 && (
