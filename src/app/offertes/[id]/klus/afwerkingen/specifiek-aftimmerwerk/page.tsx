...
export default function SpecifiekAftimmerwerkPage() {
  ...
  const handleSubmit = (event: React.MouseEvent<HTMLButtonElement>) => {
    ...
    if (items.some(p => !p.lengte || !p.breedte)) {
        toast({
            ...
            description: "Vul a.u.b. de lengte en breedte voor alle items in.",
        });
        return;
    }

    localStorage.setItem(`quote-${quoteId}-specifiek-aftimmerwerk`, JSON.stringify(items));
    router.push(`/offertes/${quoteId}/klus/afwerkingen/specifiek-aftimmerwerk/materialen`);
  };
      ...
      <div className="flex-1 p-4 md:p-8">
        <div className="max-w-2xl mx-auto w-full">
            <div className="text-center mb-8">
                 <h2 className="font-semibold text-2xl">Specifiek aftimmerwerk</h2>
                       ...
                       <CardContent className="space-y-6">
                           <div className="grid grid-cols-2 gap-4">
                               ...
                               <div className="space-y-2">
                                 ...
                                 <Input id={`breedte-${index}`} type="number" placeholder="Bijv. 250" required value={item.breedte} onChange={(e) => handleItemChange(index, 'breedte', e.target.value)} />
                               </div>
                           </div>
