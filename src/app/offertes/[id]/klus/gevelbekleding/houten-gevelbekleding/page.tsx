...
export default function HoutenGevelbekledingPage() {
  ...
  const handleSubmit = (event: React.MouseEvent<HTMLButtonElement>) => {
    ...
    localStorage.setItem(`quote-${quoteId}-houten-gevelbekleding`, JSON.stringify(gevelvlakken));
    
    router.push(`/offertes/${quoteId}/klus/gevelbekleding/houten-gevelbekleding/materialen`);
  };
      ...
      <div className="flex-1 p-4 md:p-8">
        <div className="max-w-2xl mx-auto w-full">
            <div className="text-center mb-8">
                 <h2 className="font-semibold text-2xl">Houten Gevelbekleding</h2>
