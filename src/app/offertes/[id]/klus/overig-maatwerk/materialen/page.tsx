    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent>
        <DialogHeader>
          ...
          <DialogDescription>
            Sla de huidige materiaalconfiguratie op voor later gebruik bij Overig / Maatwerk.
          </DialogDescription>
        </DialogHeader>
        <div className="space-y-4 py-4">
            ...
            <div className="flex items-center space-x-2">
                ...
                <Label htmlFor="default-preset">Maak dit mijn standaard voor Overig / Maatwerk</Label>
            </div>
        </div>
        <DialogFooter>
...
export default function OverigMaatwerkMaterialenPage() {
  ...
  const JOB_TYPE = "overig-maatwerk";
        ...
        <div className="flex-1 p-4 md:p-8">
          <div className="max-w-2xl mx-auto w-full">
              <div className="text-center mb-8">
                   <h1 className="font-semibold text-2xl md:text-3xl">Materialen – Overig / Maatwerk</h1>
