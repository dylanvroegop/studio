...
export default function OverkappingPergolaPage() {
  ...
  const subcategories: Subcategory[] = [
    { name: 'Overkapping / Pergola', description: 'Overkapping', icon: 'pergola', href: `/offertes/${quoteId}/klus/overkapping-pergola/overkapping` },
    { name: 'Overkapping / Pergola', description: 'Pergola', icon: 'pergola', href: `/offertes/${quoteId}/klus/overkapping-pergola/pergola` },
    { name: 'Overkapping / Pergola', description: 'Veranda', icon: 'pergola', href: `/offertes/${quoteId}/klus/overkapping-pergola/veranda` },
    { name: 'Overkapping / Pergola', description: 'Overig', icon: 'plus', href: `/offertes/${quoteId}/klus/overkapping-pergola/overig` },
  ];
  ...
  return (
    <main className="flex flex-1 flex-col">
      <header className="sticky top-0 z-10 grid h-14 w-full grid-cols-3 items-center border-b bg-background/95 px-4 backdrop-blur-sm sm:px-6">
        ...
        <h1 className="text-center font-semibold text-lg">Overkapping/Pergola: stap 3 van 6</h1>
