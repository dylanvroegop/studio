...
function PageSkeleton() {
  return (
    <div className="app-shell min-h-screen bg-background">
      <AppNavigation />
      <DashboardHeader user={null} title="Prijs import aanvragen" />
...
export default function PrijsImportAanvragenPage() {
  ...
  return (
    <div className="app-shell min-h-screen bg-background">
      <AppNavigation />
      <DashboardHeader user={user} title="Prijs import aanvragen" />

      <main className="flex flex-col items-center p-4 pb-10 md:px-6 md:pt-6">
        <div className="w-full max-w-6xl rounded-xl border border-border/60 bg-card/40 p-6">
