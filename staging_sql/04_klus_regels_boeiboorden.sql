  ...
  "calculation_rules": {
    ...
    "beplating": {
      "keralit_panelen": {
        ...
        "logic": "precomputed one-dimensional cut plan; every visible course is one uninterrupted cut",
        "joint_alignment": "no_joints_per_course",
        ...
        "missing_input_behavior": "requires_manual_input",
        "wastePercentage": "ignored_cut_plan_includes_offcuts"
      }
    },
    "afwerking": {
      "ventilatieprofiel": {
